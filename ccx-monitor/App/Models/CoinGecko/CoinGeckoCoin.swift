...
extension CoinGecko {
    struct CoinMarketData: Codable, Identifiable, Equatable, Hashable {
        let id: UUID = UUID()
...
extension CoinGecko.CoinMarketData {
    static let `default` = CoinGecko.CoinMarketData(coinGeckoId: "bitcoin",
                                                    symbol: "btc",
                                                    name: "Bitcoin",
